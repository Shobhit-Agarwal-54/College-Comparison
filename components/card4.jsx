...
export default function Card4({
  ...
  return (
    <div className="relative px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
      ...
      >
        {/* Page 1 — Overview & Pre-Law Resources */}
        <div className="min-w-full snap-center bg-white shadow-xl rounded-2xl p-4 sm:p-6 space-y-4">
          ...
          <div>
            <h3 className="text-lg sm:text-xl font-semibold">Overview & Location:</h3>
            <p className="text-sm sm:text-base">{overview}</p>
          </div>

          <div>
            <h3 className="sm:text-xl text-lg font-semibold">Pre-Law Resources & Programs:</h3>
            <ul className="list-disc list-inside text-sm sm:text-base space-y-1">
              {preLawResources.map((item, i) => (
                <li key={i}>{item}</li>
              ))}
            </ul>
          </div>
        ...
        {/* Page 2 — Accelerated Pathways & Internships */}
        <div className="min-w-full snap-center bg-white shadow-xl rounded-2xl p-4 sm:p-6 space-y-4">
          <div>
            <h3 className="text-lg sm:text-xl font-semibold">Accelerated Pathways:</h3>
            <ul className="list-disc list-inside text-sm sm:text-base space-y-1">
              {acceleratedPathways.map((item, i) => (
                <li key={i}>{item}</li>
              ))}
            </ul>
          </div>
          ...
          <div>
            <h3 className="text-lg sm:text-xl font-semibold">Internships & Experiential Learning:</h3>
            <ul className="list-disc list-inside text-sm sm:text-base space-y-1">
        ...
        <div className="min-w-full snap-center bg-white shadow-xl rounded-2xl p-4 sm:p-6 space-y-4">
          <div>
            <h3 className="sm:text-xl text-lg font-semibold">Career Outcomes & Notable Highlights:</h3>
            <ul className="list-disc list-inside text-sm sm:text-base space-y-1">
