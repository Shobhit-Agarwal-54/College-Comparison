...
export const ContactUs = () => {
  ...
  if (!feedback) {
    ...
    return(    
        submit==false ?(
          // dark:bg-gray-800
    <div className="max-w-xl w-full mx-auto px-4 py-6 sm:px-6 lg:px-8 rounded-2xl shadow-md mt-10 mb-10 ">
      {/* dark:text-gray-100 */}
      ...
      <form ref={form} onSubmit={sendEmail} className="space-y-5">
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full border border-gray-300 text-sm sm:text-base   rounded-xl 
        ...
        <div>
          ...
          <select
            ...
            className="w-full border text-sm sm:text-base  border-gray-300 rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400"
          >
        ...
        <div>
          ...
          <label htmlFor="user_email" className="block text-gray-700  font-medium mb-1">
            Your Email <span className="text-gray-500  text-sm">(optional, for follow-up)</span>
          </label>
          <input
            type="email"
            id="user_email"
      ...
      // dark:bg-gray-800
        <div className="max-w-xl w-full mx-auto  px-4 sm:px-6 lg:px-8 py-6 rounded-2xl shadow-md mt-10 mb-10 ">
            <div
      ...
      {/* dark:text-gray-300 */}
      <h3 className='text-gray-600  text-sm sm:text-base '>Thanks for submitting your feedback! We really appreciate your time.</h3>
