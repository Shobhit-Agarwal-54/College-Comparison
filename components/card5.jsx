...
export default function MedicalCollegeCard({
  name,
  overview,
  uniqueStrengths,
  ...
  return (
    <div className="relative px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto mb-10">
      {/* Scroll Buttons */}
      <button
        onClick={() => scroll('left')}
      ...
      >
        {/* Page 1 — Overview & Unique Strengths */}
        <div className="min-w-full snap-center bg-white shadow-xl rounded-2xl p-4 sm:p-6 space-y-4">
          ...
          <div>
            <h3 className="sm:text-xl text-lg font-semibold">Unique Strengths:</h3>
            <ul className="list-disc list-inside text-sm sm:text-base space-y-1">
              {uniqueStrengths.map((item, i) => (
                <li key={i}>{item}</li>
              ))}
            </ul>
          </div>
        ...
        {/* Page 2 — Research Opportunities & Clinical Exposure */}
        <div className="min-w-full snap-center bg-white shadow-xl rounded-2xl p-4 sm:p-6 space-y-4">
          <div>
            <h3 className="text-lg sm:text-xl font-semibold">Research Opportunities:</h3>
            <ul className="list-disc list-inside text-sm sm:text-base space-y-1">
              {researchOpportunities.map((item, i) => (
                <li key={i}>{item}</li>
              ))}
            </ul>
          </div>
          ...
          <div>
            <h3 className="text-lg sm:text-xl font-semibold">Clinical Exposure:</h3>
            <ul className="list-disc list-inside text-sm sm:text-base space-y-1">
              {clinicalExposure.map((item, i) => (
                <li key={i}>{item}</li>
              ))}
            </ul>
          </div>
        ...
        <div className="min-w-full snap-center bg-white shadow-xl rounded-2xl p-4 sm:p-6 space-y-4">
          ...
          <p className="text-gray-900 text-sm sm:text-base leading-relaxed">
            Want to compare this medical school with others? Try our{' '}
            <Link
              target="_blank"
