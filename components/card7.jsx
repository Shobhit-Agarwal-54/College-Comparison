    ...
    <div className="relative px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
      ...
      >
        ...
        <div className="min-w-full snap-center bg-white shadow-xl rounded-2xl p-4 sm:p-6 space-y-4">
          ...
          <div>
            <h3 className="sm:text-xl text-lg font-semibold">Programs & Curriculum:</h3>
        ...
        <div className="min-w-full snap-center bg-white shadow-xl rounded-2xl p-4 sm:p-6 space-y-4">
          <div>
            <h3 className="sm:text-xl text-lg font-semibold">Industry Connections:</h3>
            <ul className="list-disc list-inside text-sm sm:text-base">
              {industryConnections.map((item, index) => (
                <li key={index}>{item}</li>
              ))}
            </ul>
          </div>
          ...
          <div>
            <h3 className="sm:text-xl text-lg font-semibold">Facilities & Resources:</h3>
            <ul className="list-disc list-inside text-sm sm:text-base">
